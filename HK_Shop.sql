...
--
-- Tabellenstruktur für Tabelle `Spielzeug`
--
...
--
-- Indizes für die Tabelle `Spielzeug`
--
ALTER TABLE `Spielzeug`
  ADD PRIMARY KEY (`sId`);
...
--
-- AUTO_INCREMENT für Tabelle `Spielzeug`
--
ALTER TABLE `Spielzeug`
